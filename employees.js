...
//CODE HERE
let manager = new Manager('Winston', ['weekday mornings', 'weekday afternoons'], ['Cece', 'Schmidt', 'Sam', 'John'])
...
//CODE HERE 
manager.addEmployee(new Employee('Tommy', ['weekday mornings', 'weekday afternoons']))
